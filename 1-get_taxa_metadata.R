...
### DESCRIPTION:
  ...
  ## The current IUCN Red List threat category (if available) is also matched 
  #   to your target taxa list
...
tryCatch(taxon_list[which(is.na(taxon_list$rl_category)),]$rl_category <- 
           "Not Evaluated", error = \(e) message("All assessed on the RL"))
